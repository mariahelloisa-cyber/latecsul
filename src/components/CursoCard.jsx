  ...
  return (
    ...
    >
      <div className="relative w-full aspect-[2/1] shrink-0 overflow-hidden bg-gray-900">
        ...
        {curso.categoria && (
          <span className="absolute top-3 right-3 bg-[#01923F] text-white text-[9px] font-bold px-2.5 py-1 rounded-full shadow-md">
            {curso.categoria}
          </span>
        )}
      </div>
      ...
      <div className="p-4 flex flex-col flex-grow">
        ...
        <div className="flex flex-wrap gap-1.5 mb-4">
          ...
          {curso.carga_horaria && (
            <span className="inline-flex items-center gap-1 bg-red-50 text-red-700 text-[9px] font-bold px-2 py-1 rounded-full">
              <BoltIcon className="w-2.5 h-2.5" /> {curso.carga_horaria}
            </span>
          )}
          <span className="inline-flex items-center gap-1 bg-emerald-50 text-emerald-700 text-[9px] font-bold px-2 py-1 rounded-full">
            <BookOpenIcon className="w-2.5 h-2.5" /> EAD
          </span>
        </div>

        <span className="mt-auto w-full inline-flex items-center justify-center gap-2 bg-gradient-to-r from-[#01923F] to-[#046B30] group-hover:from-[#046B30] group-hover:to-[#034D23] text-white font-black text-[11px] uppercase tracking-wider py-3.5 rounded-full shadow-md transition-all group-hover:gap-3">
