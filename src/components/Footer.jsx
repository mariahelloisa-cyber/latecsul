...
import { urlSeguraExterna, emailSeguro } from '../utils/urlSegura';
...
export default function Footer() {
  ...
  // O numero do WhatsApp vem do banco e e concatenado na URL wa.me. Mantem so
  // digitos para que o valor nao consiga introduzir '/', '?' ou '#' e mudar o
  // destino do link; se sobrar vazio, cai no numero padrao do topo do arquivo.
  const whatsappNumero = String(contato.whatsapp_numero || '').replace(/\D/g, '') || CONTATO_PADRAO.whatsapp_numero;
  const emailContato = emailSeguro(contato.email);

  return (
    <footer className="bg-white text-gray-600">
      {/* Barra gradiente superior */}
      <div className="w-full h-1.5 bg-gradient-to-r from-[#01923F] via-[#046B30] to-[#034D23]" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          <div className="md:col-span-4 flex flex-col gap-3">
            ...
            <div className="flex items-center gap-2.5">
              <a href={urlSeguraExterna(contato.instagram_url)} target="_blank" rel="noreferrer" aria-label="Instagram" className="w-8 h-8 rounded-full border border-[#01923F]/40 text-[#01923F] flex items-center justify-center hover:bg-[#01923F] hover:text-white hover:border-[#01923F] transition-colors">
              ...
              <a href={urlSeguraExterna(contato.facebook_url)} target="_blank" rel="noreferrer" aria-label="Facebook" className="w-8 h-8 rounded-full border border-[#01923F]/40 text-[#01923F] flex items-center justify-center hover:bg-[#01923F] hover:text-white hover:border-[#01923F] transition-colors">
              ...
              <a href={`https://wa.me/${whatsappNumero}`} target="_blank" rel="noreferrer" aria-label="WhatsApp" className="w-8 h-8 rounded-full border border-[#01923F]/40 text-[#01923F] flex items-center justify-center hover:bg-[#01923F] hover:text-white hover:border-[#01923F] transition-colors">
          ...
          <div className="md:col-span-3 md:border-l md:border-gray-200 md:pl-8 flex flex-col gap-2.5">
            <div className="flex flex-col gap-1.5">
              ...
              <span className="block w-8 h-0.5 bg-[#01923F] rounded-full" />
            </div>
            <ul className="flex flex-col gap-1.5 text-sm">
              <li>
                <a href="/" className="flex items-center gap-1.5 hover:text-[#01923F] transition-colors">
                  <span className="text-[#01923F] font-bold">›</span> Início
                </a>
              </li>
              <li>
                <a href="/cursos" className="flex items-center gap-1.5 hover:text-[#01923F] transition-colors">
                  <span className="text-[#01923F] font-bold">›</span> Cursos
                </a>
              </li>
              <li>
                <a href="/blog" className="flex items-center gap-1.5 hover:text-[#01923F] transition-colors">
                  <span className="text-[#01923F] font-bold">›</span> Blog
                </a>
              </li>
              <li>
                <a href="/sobre" className="flex items-center gap-1.5 hover:text-[#01923F] transition-colors">
                  <span className="text-[#01923F] font-bold">›</span> Quem Somos
                </a>
              </li>
            </ul>
          </div>
          ...
          <div className="md:col-span-5 md:border-l md:border-gray-200 md:pl-8 flex flex-col gap-2.5">
            ...
            <ul className="flex flex-col gap-2 text-sm">
              ...
              <li className="flex items-center gap-2.5">
                ...
                <a href={emailContato ? `mailto:${emailContato}` : undefined} className="hover:text-[#01923F] transition-colors">
                  {contato.email}
                </a>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-200 mt-6 pt-4 flex flex-col sm:flex-row justify-between items-center gap-3 text-xs text-gray-500">
          <p>© {anoAtual} LATec Sul. Todos os direitos reservados.</p>
          <div className="flex items-center gap-3">
            <a href="/privacidade" className="hover:text-[#01923F] transition-colors">Política de Privacidade</a>
            <span className="w-px h-3 bg-gray-300" />
            <a href="/termos" className="hover:text-[#01923F] transition-colors">Termos de Uso</a>
          </div>
        </div>
