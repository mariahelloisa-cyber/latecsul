        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          <div className="md:col-span-4 flex flex-col gap-3">
            ...
            <div className="flex items-center gap-2.5">
              ...
              <a href={contato.facebook_url || '#'} target="_blank" rel="noreferrer" aria-label="Facebook" className="w-8 h-8 rounded-full border border-[#01923F]/40 text-[#01923F] flex items-center justify-center hover:bg-[#01923F] hover:text-white hover:border-[#01923F] transition-colors">
              ...
              <a href={`https://wa.me/${contato.whatsapp_numero}`} target="_blank" rel="noreferrer" aria-label="WhatsApp" className="w-8 h-8 rounded-full border border-[#01923F]/40 text-[#01923F] flex items-center justify-center hover:bg-[#01923F] hover:text-white hover:border-[#01923F] transition-colors">
          ...
          <div className="md:col-span-5 md:border-l md:border-gray-200 md:pl-8 flex flex-col gap-2.5">
            ...
            <ul className="flex flex-col gap-2 text-sm">
              ...
              <li className="flex items-center gap-2.5">
                ...
                <a href={`https://wa.me/${contato.whatsapp_numero}`} target="_blank" rel="noreferrer" className="hover:text-[#01923F] transition-colors">
                  {contato.telefone}
                </a>
              </li>
              <li className="flex items-center gap-2.5">
                ...
                <a href={`mailto:${contato.email}`} className="hover:text-[#01923F] transition-colors">
                  {contato.email}
                </a>
              </li>
            </ul>
