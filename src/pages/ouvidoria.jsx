  ...
  return (
    <div className="w-full min-h-screen bg-[#F8F9FA] text-gray-900 font-sans antialiased pb-24">
      ...
      <div className="max-w-4xl mx-auto px-4 pt-16 flex flex-col items-center">
        ...
        <div className="w-14 h-14 rounded-full bg-[#EAFAF1] flex items-center justify-center text-[#01923F] shadow-sm mb-5 border border-[#EAFAF1]">
        ...
        <div className="w-full bg-white rounded-[2rem] shadow-[0_20px_50px_-15px_rgba(0,0,0,0.05)] border border-gray-100 overflow-hidden">
          ...
          <div className="bg-[#111625] py-5 px-8 flex items-center justify-center gap-2.5">
            <svg className="w-5 h-5 text-[#01923F]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2.2">
          ...
          <form onSubmit={handleSubmit} className="p-8 md:p-12 flex flex-col gap-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-[#F8F9FA] border border-gray-200 rounded-2xl px-5 py-3.5 text-sm font-medium text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#01923F]/10 focus:border-[#01923F] transition-all disabled:opacity-50"
                />
              </div>
            ...
            <div>
              ...
              <textarea
                ...
                rows="5"
                disabled={status === 'enviando'}
                className="w-full bg-[#F8F9FA] border border-gray-200 rounded-2xl px-5 py-4 text-sm font-medium text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#01923F]/10 focus:border-[#01923F] transition-all resize-none leading-relaxed disabled:opacity-50"
              ></textarea>
            </div>
            ...
            <button
              type="submit"
              disabled={status === 'enviando'}
              className="w-full text-center bg-gradient-to-r from-[#01923F] to-[#034D23] text-white font-bold text-xs md:text-sm uppercase tracking-widest py-4.5 rounded-2xl transition-all duration-300 hover:opacity-95 shadow-md hover:shadow-lg active:scale-[0.99] mt-2 disabled:opacity-70 flex justify-center items-center gap-2"
            >
              {status === 'enviando' ? (
                <>
