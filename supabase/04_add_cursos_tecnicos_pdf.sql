...
(
  'Técnico em Análises Clínicas EAD',
  'Prepare-se para atuar em laboratórios de análises clínicas, hospitais e clínicas de saúde. O curso desenvolve competências em microbiologia, biologia celular e molecular, fisiopatologia e controle de infecção hospitalar, formando profissionais capacitados para o diagnóstico laboratorial. Estude no seu ritmo, com aulas 100% on-line e certificação reconhecida.',
  'Técnicos',
  2,
  900.00,
  1590.00,
  ...
  '',
  $grade1$1º Semestre
Introdução à EAD | 50h
Empreendedorismo | 60h
Ética Profissional | 60h
Introdução à Análises Clínicas e Microbiologia | 100h
Tratamento e Reciclagem de Águas Residuárias e Lixo | 40h
Análises Microbiológicas de Alimentos e Água | 100h
Biologia Celular e do Desenvolvimento | 50h
Controle de Infecção Hospitalar | 60h

2º Semestre
Oncologia Clínica e Técnica de Manipulação de Medicamentos Oncológicos | 60h
Imunologia e Microbiologia | 80h
Fisiopatologia do Sistema Renal e Urinário | 100h
Fisiopatologia do Sistema Renal e Urinário | 60h
Biologia Molecular e Estrutural | 100h
Biologia Molecular | 60h
Biologia Celular | 60h
Trabalho de Conclusão de Curso (TCC) | 220h$grade1$,
  $blocos1$## Curso Técnico em Análises Clínicas: O que é
O Técnico em Análises Clínicas forma profissionais aptos a atuar na coleta, processamento e análise de amostras biológicas em laboratórios clínicos, hospitais e centros de diagnóstico. Autorizado e reconhecido, o curso une fundamentos de microbiologia, biologia celular e molecular a conteúdos práticos de rotina laboratorial.

## Objetivo do Curso
Formar profissionais capacitados a auxiliar no diagnóstico laboratorial, compreendendo desde a coleta de amostras até a interpretação de exames microbiológicos, garantindo qualidade e segurança nos processos de análise clínica.

Ao concluir o curso, o aluno estará apto a:

atuar em laboratórios de análises clínicas e hospitais;
realizar análises microbiológicas de alimentos e água;
aplicar boas práticas de controle de infecção hospitalar;
compreender a fisiopatologia dos principais sistemas do corpo humano;
apoiar equipes de saúde em rotinas de diagnóstico laboratorial.

## Metodologia de Ensino
O curso é ministrado 100% na modalidade EaD, através de um Ambiente Virtual de Aprendizagem (AVA) dinâmico e facilitador. O aluno conta com vídeoaulas, materiais didáticos e acompanhamento pedagógico durante toda a formação, incluindo o desenvolvimento do Trabalho de Conclusão de Curso (TCC).

## Mercado de Trabalho e Oportunidades
A demanda por profissionais de análises clínicas cresce junto com a rede de laboratórios, hospitais e clínicas de diagnóstico do país. Com a formação, o aluno amplia suas oportunidades em:

laboratórios de análises clínicas;
hospitais e clínicas de diagnóstico;
vigilância sanitária e controle de qualidade de alimentos e água;
concursos públicos na área da saúde.

## Avaliação e Certificação
Será conferido certificado de conclusão aos alunos que cumprirem as exigências pedagógicas e acadêmicas do Projeto Pedagógico do Curso: 75% de participação nas aulas do AVA e nota igual ou superior à média estabelecida.$blocos1$
),
